  ...
  return <footer className="bg-[#0a1a3e] text-white mt-8 mb-16 md:mb-0">
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-5">
        <div>
          <p className="font-black text-xs mb-2.5 text-white/90 uppercase tracking-wide">ກ່ຽວກັບ BlueWhale</p>
        ...
        <div>
          <p className="font-black text-xs mb-2.5 text-white/90 uppercase tracking-wide">ນະໂຍບາຍ & ກົດລະບຽບ</p>
          <ul className="space-y-1.5 text-xs text-white/50">
        ...
        <div>
          <p className="font-black text-xs mb-2.5 text-white/90 uppercase tracking-wide">ສູນຊ່ວຍເຫຼືອ</p>
          <ul className="space-y-1.5 text-xs text-white/50">
        ...
        <div>
          <p className="font-black text-xs mb-2.5 text-white/90 uppercase tracking-wide">ຕິດຕໍ່ພວກເຮົາ</p>
          <ul className="space-y-1.5 text-xs text-white/50">
            <li>📍 ວຽງຈັນ, ລາວ</li>
            <li>📞 020 9269 9612</li>
          ...
          <div className="flex gap-2 mt-3">
            <a href="https://facebook.com/BlueWhalelao" target="_blank" rel="noopener noreferrer"
              className="w-7 h-7 rounded-full bg-white/10 hover:bg-[#1877F2] flex items-center justify-center transition-colors">
            ...
            <a href="https://tiktok.com/@BlueWhalelao" target="_blank" rel="noopener noreferrer"
              className="w-7 h-7 rounded-full bg-white/10 hover:bg-black flex items-center justify-center transition-colors">
              <svg className="w-3.5 h-3.5 fill-white" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.19 8.19 0 004.79 1.54V6.78a4.85 4.85 0 01-1.02-.09z"/></svg>
            </a>
            <a href="https://instagram.com/BlueWhalelao" target="_blank" rel="noopener noreferrer"
              className="w-7 h-7 rounded-full bg-white/10 hover:bg-[#E1306C] flex items-center justify-center transition-colors">
            ...
            <a href="https://youtube.com/@BlueWhalelao" target="_blank" rel="noopener noreferrer"
              className="w-7 h-7 rounded-full bg-white/10 hover:bg-[#FF0000] flex items-center justify-center transition-colors">
    ...
    <div className="border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center gap-3">
        <span className="text-xs text-white/40 shrink-0">ຮັບຊຳລະ:</span>
        <div className="flex items-center gap-2">
          <div className="bg-white rounded px-1.5 py-0.5 h-7 flex items-center">
            <img src="/bcel-one.webp" alt="BCEL One" className="h-5 w-auto object-contain" />
          </div>
          <div className="bg-white rounded px-1.5 py-0.5 h-7 flex items-center">
            <img src="/jdb.png" alt="JDB" className="h-5 w-auto object-contain" />
          </div>
          <div className="bg-white rounded px-1.5 py-0.5 h-7 flex items-center">
            <img src="/ldb.jpg" alt="LDB" className="h-5 w-auto object-contain" />
          </div>
          <div className="bg-green-600 rounded px-2 h-7 flex items-center">
            <span className="text-white font-black text-[10px]">COD ຈ່າຍປາຍທາງ</span>
          </div>
        </div>
        <p className="text-xs text-white/30 ml-auto">© 2026 BlueWhale · <a href="#" className="hover:text-white/60">ນະໂຍບາຍ</a> · <a href="#" className="hover:text-white/60">ເງື່ອນໄຂ</a></p>
      </div>
    </div>
  </footer>
}
