        ...
        <div className="p-6 space-y-4">
          ...
          {tab === 'email' && (
            <form onSubmit={registerEmail} className="space-y-4">
              <div>
                <label className="text-xs font-bold text-gray-500 mb-1 block uppercase tracking-wide">ຊື່</label>
          ...
          {tab === 'facebook' && (
            <div className="space-y-4 py-2">
              <p className="text-sm text-gray-500 text-center">ສ້າງ / ເຂົ້າລະບົບດ້ວຍ Facebook</p>
              <button onClick={loginFacebook} disabled={loading}
                ...
                {loading ? 'ກຳລັງໂຫຼດ...' : 'ສືບຕໍ່ດ້ວຍ Facebook'}
              </button>
