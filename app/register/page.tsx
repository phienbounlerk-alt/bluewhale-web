        ...
        <div className="p-6 space-y-3">
          ...
          {mode === 'choose' && (
            <>
              ...
              <button onClick={loginGoogle} disabled={loading}
                ...
                <span className="font-bold text-gray-700">{loading ? 'ກຳລັງໂຫຼດ...' : 'ສືບຕໍ່ດ້ວຍ Google'}</span>
              </button>
              ...
              <button onClick={loginFacebook} disabled={loading}
                ...
                <span className="font-bold text-white">{loading ? 'ກຳລັງໂຫຼດ...' : 'ສືບຕໍ່ດ້ວຍ Facebook'}</span>
              </button>
              ...
              <button onClick={() => setMode('phone')} disabled={loading}
                ...
                <span className="font-bold text-white">ສ້າງບັນຊີດ້ວຍ ເບີໂທ</span>
              </button>
              ...
              <button onClick={() => setMode('email')} disabled={loading}
                ...
                <span className="font-bold text-white">ສ້າງບັນຊີດ້ວຍ ອີເມວ</span>
              </button>
            </>
          )}
          ...
          {mode === 'phone' && (
            <form onSubmit={registerPhone} className="space-y-3">
              ...
              <p className="font-bold text-gray-700 text-center pb-1">ສ້າງບັນຊີດ້ວຍ ເບີໂທ</p>
              <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden focus-within:border-[#1247D8] transition-colors">
                ...
                <input value={name} onChange={e => setName(e.target.value)} required
                  placeholder="ຊື່ຂອງທ່ານ" autoFocus
          ...
          {mode === 'email' && (
            <form onSubmit={registerEmail} className="space-y-3">
              ...
              <p className="font-bold text-gray-700 text-center pb-1">ສ້າງບັນຊີດ້ວຍ ອີເມວ</p>
              <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden focus-within:border-[#1247D8] transition-colors">
                <svg className="w-4 h-4 mx-3 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
