    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="bg-white rounded-3xl shadow-lg p-8 w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black text-gray-800">ສ້າງບັນຊີໃໝ່</h1>
          <p className="text-gray-400 text-sm mt-1">ຮ່ວມກັບ BlueWhale ວັນນີ້</p>
        </div>

        <form onSubmit={submit} className="space-y-4">
          <div>
            <label className="text-sm font-bold text-gray-600 mb-1 block">ຊື່</label>
