      ...
      <div className="bg-white rounded-3xl shadow-lg w-full max-w-sm overflow-hidden">
        ...
        <div className="px-6 pt-5 space-y-3">
          ...
          <button onClick={loginGoogle} disabled={loading}
            ...
            <span className="flex-1 text-center text-sm">{loading ? 'ກຳລັງໂຫຼດ...' : 'ເຂົ້າລະບົບດ້ວຍ Google'}</span>
          </button>
          <button onClick={loginFacebook} disabled={loading}
            ...
            <span className="flex-1 text-center text-sm">{loading ? 'ກຳລັງໂຫຼດ...' : 'ເຂົ້າລະບົບດ້ວຍ Facebook'}</span>
          </button>
        </div>
