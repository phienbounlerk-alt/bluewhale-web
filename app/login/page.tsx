        ...
        <div className="p-6 space-y-3">
          ...
          {mode === 'choose' && (
            <>
              ...
              <button onClick={loginGoogle} disabled={loading}
                ...
                <span className="font-bold text-gray-700">{loading ? 'ກຳລັງໂຫຼດ...' : 'ເຂົ້າລະບົບດ້ວຍ Google'}</span>
              </button>
          ...
          {mode === 'phone' && (
            <form onSubmit={loginPhone} className="space-y-3">
              ...
              <p className="font-bold text-gray-700 text-center pb-1">ເຂົ້າລະບົບດ້ວຍ ເບີໂທ</p>
              ...
              <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden focus-within:border-[#1247D8] transition-colors">
                ...
                <button type="button" onClick={() => setShowPwd(s => !s)} className="px-3 text-gray-400 hover:text-gray-600">
                  {showPwd
          ...
          {mode === 'email' && (
            <form onSubmit={loginEmail} className="space-y-3">
              ...
              <p className="font-bold text-gray-700 text-center pb-1">ເຂົ້າລະບົບດ້ວຍ ອີເມວ</p>
              <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden focus-within:border-[#1247D8] transition-colors">
                <svg className="w-4 h-4 mx-3 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
